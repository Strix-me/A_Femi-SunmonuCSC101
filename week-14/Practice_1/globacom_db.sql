...
CREATE TABLE public.department (
    depnt_managerid integer NOT NULL,
    dno integer NOT NULL,
    dname text NOT NULL,
    dlocation character varying(54),
...
COPY public.department (depnt_managerid, dno, dname, dlocation, pno) FROM stdin;
...
100	Mustapah Ali	3	175000	32	8063286831
...
120	Adeleke Jake	4	200000	38	7061045862
122	Osahon Mark	6	300000	44	8022289842
...
ALTER TABLE ONLY public.department
    ADD CONSTRAINT department_pkey PRIMARY KEY (depnt_managerid);
